...
function About() {
  return (
    <div class="container-about">
      ...
      <h3 className='aboutText'>Muloo is a unique retail shop that caters to adults who love “kawaii” or “cute” character goods. We carry toys, gifts, apparel, accessories, art, and more, all inspired by Japanese and Los Angeles Pop Culture. Jamie Rivadeneira started the store, in 2006. Many items are imported from Japan!
      ...
      Muloo encourages people of all ages to embrace their love of cute things and share it with friends! Join the Cute Culture! </h3>
